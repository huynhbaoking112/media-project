...
const AllComment = ({ comment, allCommentReply, setAllCommetHandle,HandleDecrementComment }) => {
  ...
  return (
    <div className="flex gap-1  ">
      ...
      <div className="flex flex-col w-full mx-1    ">
          ...
          <div className="flex flex-col w-full">
            ...
            {isOpenChange && (
              <div className="flex w-full items-center justify-between">
                <input
                  className="outline-none border-[1px] rounded-lg mt-[3px] px-2 py-1 w-[80%]"
        ...
        <div className="flex gap-2 text-[13px]  px-2">
        ...
        <div className="w-full ml-[15px] flex flex-col gap-2 mt-1">
          {isOpenReply && (
            <div className="flex w-full items-center gap-3">
              <input
                className="outline-none px-2 py-1 w-[70%] rounded-lg border-[1px]"
              ...
              <div className="relative group/air">
                <HiPaperAirplane
                  size={23}
                  className="rotate-45 hover:scale-105 duration-300 hover:text-blue-400 hover:cursor-pointer "
