...
import AllCommentInPost from "./AllCommentInPost";

const CommentInPostPage = ({
  postId,
  authorPostId,
  openComment,
        ...
        <div className="flex items-center">
          ...
          <div className="flex flex-col w-full px-2">
            <input
              ...
              className="w-full mx-2 bg-[#3A3B3C] text-yellow-50 pl-2 py-2 rounded-tr-lg rounded-tl-lg outline-none border-t-[1px] border-l-[1px] border-r-[1px]   "
              onKeyDown={(e) => {
                if (e.code == "Enter") {
                  HandleClick();
                }
            ...
            <div className="flex py-2 justify-between border-b-[1px] border-l-[1px] border-r-[1px] w-full rounded-br-lg rounded-bl-lg mx-2 px-2 ">
              <div className="flex gap-2 items-center ">
                <div className="relative group/image">
                  <p className=" absolute  top-[-20px] left-[-5px]  bg-gray-200 text-gray-400  text-[10px] rounded-lg border-[1px] p-1 hidden group-hover/image:flex">
                    image{" "}
                  </p>
                  <BiImage
                    size={24}
                ...
                <div className="relative group/icon">
                  <p className=" absolute  top-[-20px] left-[-5px]  bg-gray-200 text-gray-400  text-[10px] rounded-lg border-[1px] p-1 hidden group-hover/icon:flex">
                    icon{" "}
                  </p>
        ...
        {allCommentReply?.map((e) => {
          return (
            <AllCommentInPost
              comment={e}
              key={e._id}
              setAllCommetHandle={setAllCommetHandle}
              allCommentReply={allCommentReply}
...
export default CommentInPostPage;
